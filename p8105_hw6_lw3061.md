...
Here I run the same regression with `glm` on all the cities in the
dataset:
...
|-----------:|-----------:|-----------:|----------:|----------:|----------:|
| -0.0018862 | -0.0096676 |  0.0082887 | 0.9169688 | 0.8880862 | 0.9403925 |

After 5000 bootstraps, the 95% CI for the r-squared values is
(0.8880862, 0.9403925) and the CI for the log(beta1 \* beta2) values is
(-0.0096676, 0.0082887).
